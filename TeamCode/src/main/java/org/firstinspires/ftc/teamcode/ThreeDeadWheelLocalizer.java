...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
       ...
       // public double par0YTicks = -2652.582385; // y position of the first parallel encoder (in tick units)
        // from opmode
        public double par0YTicks = -2339.532607869688;//-2707.6033831090717; // y position of the first parallel encoder (in tick units)
        // 7.875in
        //public double par1YTicks = 2652.582385; // y position of the second parallel encoder (in tick units)
        // from opmode
        public double par1YTicks = 2140.9563798781714;//2594.7917025268475; // y position of the second parallel encoder (in tick units)
        // 6.5625in
        //public double perpXTicks = -2210.485321; // x position of the perpendicular encoder (in tick units)
        // from opmode
        public double perpXTicks = -2097.5404826647555;//-2186.9015480307753; // x position of the perpendicular encoder (in tick units)
    }
