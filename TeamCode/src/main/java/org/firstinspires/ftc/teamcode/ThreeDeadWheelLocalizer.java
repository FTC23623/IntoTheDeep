...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2701.285904527864; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2613.3308369585034; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2233.796624269734; // x position of the perpendicular encoder (in tick units)
    }
